...
$atts = array_merge( vc_map_get_attributes( $this->getShortcode(), $atts ), $atts); //some additional attributes for icon are not listed in default attributes
extract( $atts );
