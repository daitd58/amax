...
<div class="<?php echo apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base'], $atts ) ?>">
	<div class="wpb_wrapper">
		...
		<div id="<?php echo esc_attr($carousel_id) ?>" data-ride="vc_carousel"
			 ...
			 data-interval="<?php echo esc_attr(($autoplay == 'yes' ? $speed : 0)) ?>" data-auto-height="true"
			 data-mode="<?php echo esc_attr($mode) ?>" data-partial="<?php echo ($partial_view === 'yes' ? 'true' : 'false') ?>"
			...
			<ol class="vc_carousel-indicators">
				...
				<li data-target="#<?php echo esc_attr($carousel_id) ?>" data-slide-to="<?php echo esc_attr($i) ?>"></li>
				<?php endfor; ?>
			</ol>
			<?php endif; ?>
			<!-- Wrapper for slides -->
			<div class="vc_carousel-inner">
				<div class="vc_carousel-slideline">
					<div class="vc_carousel-slideline-inner">
						...
						?>
						<div class="vc_item vc_slide_<?php echo esc_attr($post->post_type) ?>"<?php echo  $block_style ?>>
							<div class="vc_inner">
